...
public class SearchAndListerImpl extends AbstractComponentImpl implements SearchAndLister {
    ...
    public static final String FOLDER_PATHS = "assetFolders";
    public static final String PN_FOLDER = "folder";
